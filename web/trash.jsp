...
<%@include file="navbar.jsp" %>
        <!-- Add trash header, mail options and messages -->
                        ...
                        <div class="panel-heading">
                            <div class="row">
                                <div class="col col-xs-6">
                                    <h3 class="panel-title"><i class="fa fa-trash"></i>&nbsp;Trash</h3>
                                </div>                                
                            </div>
                        </div>
                            ...
                            <table id="inboxTable" class="table table-striped table-bordered table-list">
                                ...
                                <tr>
                                    <th class="col-check visible-md visible-lg"><input type="checkbox" id="checkAll" title="Check All"/><a class="btn btn-danger pull-right visible-md visible-lg"
                                        id="trash" title="Permanently Delete"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></a>
                                ...
                                <tbody>
                                    <tr>
                                        <td align="center" class="visible-md visible-lg"><input type="checkbox" class="checkThis visible-md visible-lg"/></td>
                                        <td align="center">
                                            <a class="btn btn-default" title="Move to Inbox"><span <i class="fa fa-inbox"
                                                                             aria-hidden="true" ></i></span></a>
                                            <a class="btn btn-danger" title="Permanently Delete"><span class="glyphicon glyphicon-trash"
        ...
        <!-- Modal for use with trash button for confirmation; Deletion is Permanent-->
        <div id="permDelModal" class="modal fade">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <p class="text-warning"><small>This action is permanent and cannot be reversed!</small></p>
                    </div>
